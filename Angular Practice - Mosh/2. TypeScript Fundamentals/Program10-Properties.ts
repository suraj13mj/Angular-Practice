...
let l1 = box_obj1.Length;                                           //Properties are like fields from outside, but internally they are internally functions/methods
...
//We can use Camel case for property names i.e "length" , but then we have to set the actual field names as _fieldname i.e "_length"
