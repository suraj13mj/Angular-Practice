...
4. But when we click on 'Load Anna' by setting the new route to http://localhost/users/10/Anna, 
  ...
  - Since the User Component has be initialised and rendered once for the first time, so when the new route also points to the same Component, Angular doesn't re-initialise and re-render the component.
